...
import { ReceiveConversation } from "./receiveConversation";
import { IMctPageProps } from "./receiveConversation.types";
import {
  ScrollablePane,
  classNamesFunction,
  initializeIcons,
...
export const MctVnextReceiveApp: FC<IMctPageProps> = (props) => {
