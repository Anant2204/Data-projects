CREATE TABLE [dbo].[Isp_rolesummary_staging] (
    ...
    [isp_discipline]             UNIQUEIDENTIFIER NULL,
    [isp_disciplinename]         NVARCHAR (MAX)   NULL,
    [isp_name]                   NVARCHAR (MAX)   NULL,
    [isp_profession]             NVARCHAR (MAX)   NULL,
    [isp_professioncode]         NVARCHAR (MAX)   NULL,
    [isp_roleanalysisindicator]  BIT              NULL,
    [isp_rolesummaryid]          UNIQUEIDENTIFIER NULL,
