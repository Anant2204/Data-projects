CREATE TABLE [dbo].[Isp_Org_staging] (
    ...
    [isp_orgcode]                NVARCHAR (MAX)   NULL,
    [isp_orggroup]               INT              NULL,
    [isp_orgid]                  UNIQUEIDENTIFIER NULL,
    [isp_orgshorttext]           NVARCHAR (MAX)   NULL,
    [isp_orgsummarycode]         NVARCHAR (MAX)   NULL,
    [isp_orgsummarydesc]         NVARCHAR (MAX)   NULL,
