// <copyright file="ReceiveConversationDto.cs" company="Microsoft">
...
namespace MCT.DataAccess.Models
{
    ...
    /// <summary>
    /// Receive conversation Dto.
    /// </summary>
    [DataContract]
    public class ReceiveConversationDto
    {
        ...
        [DataMember(Name = "sendingConversationStatus")]
        public string? SendingConversationStatus { get; set; }

        /// <summary>Gets or sets the receiving conversation status.</summary>
        [DataMember(Name = "receiveConversationStatus")]
        public string? ReceiveConversationStatus { get; set; }

        /// <summary>Gets or sets the fy manager alias.</summary>
        [DataMember(Name = "fyManagerAlias")]
        public string? FyManagerAlias
        {
            get; set;
        }
