// <copyright file="TaxonomyScriptContent.cs" company="Microsoft">
...
namespace MCT.DataAccess.Models
{
    ...
    /// <summary>
    ///   TaxonomyScriptContent
    /// </summary>
    public class TaxonomyScriptContent
    {
        ...
        public List<ExcludedManagerDetails> Exclusions { get; set; } = new List<ExcludedManagerDetails>();
