namespace MCT.API.Test
{
    ...
    public class SendStayConversationControllerTest
    {

        private readonly Mock<ISendStayConversationService> _mockService;
        ...
        private readonly SendStayConversationController _controller;
        private readonly ActionContext actionContext;

        public SendStayConversationControllerTest()
        {
            _mockService = new Mock<ISendStayConversationService>();
            ...
            _controller = new SendStayConversationController(_mockService.Object, _mockTaxonomyService.Object, _applicationState,httpContextAccessor.Object);
            _controller.ControllerContext = new ControllerContext(actionContext);
        }


        [Fact]
        public async Task CompleteSendConversation_ShouldReturnTrue()
        {
            //Arrange
            ...
            _controller.ControllerContext = new ControllerContext(actionContext);
            _controller.ControllerContext.HttpContext.Items["Roles"] = new List<string> { "Manager " };

            List<string> roleList = new List<string>();

            _mockService.Setup(x => x.SetConversationComplete(It.Is<List<ConversationCompletionRequest>>(y => y == conversationCompletionRequest), It.IsAny<string>(), It.IsAny<List<string>>())).
                ReturnsAsync(true);

            // Act
            var result = await _controller.CompleteSendConversation(conversationCompletionRequest);
        ...
        [Fact]
        public async Task CompleteSendConversation_ShouldReturnForbiddenResult_WhenIncorrectManagerPassed()
        {
            //Arrange
            var requestedData = new ConversationCompletionRequest
            {
        ...
        [Fact]
        public async Task CompleteSendConversation_ShouldReturn_InternalServerErrorOnException()
        {
            //Arrange
            var requestedData = new ConversationCompletionRequest
            {
            ...
            _mockService.Setup(x => x.SetConversationComplete(It.Is<List<ConversationCompletionRequest>>(y => y == conversationCompletionRequest), It.IsAny<string>(), roleList)).ThrowsAsync(new Exception());
        ...
        [Fact]
        public async Task CompleteSendConversation_ShouldReturnForbiddenResult_WhenUserNotLoggedIn()
        {
            //Arrange
            var requestedData = new ConversationCompletionRequest
            {
        ...
        [Fact]
        public async Task CompleteSendConversation_ReturnsInternalServerError_WhenDataNotFound()
        {
            //Arrange
            var requestedData = new ConversationCompletionRequest
            {
        ...
        public async Task Get_ShouldReturnOkResponse_WhenDataFound()
        {
            ...
            var SendEntitiesList = TestSendStayEntitiesData();
            ...
            var expectedConversation = new SendStayConversationResponse
            {
                Conversations = SendEntitiesList.Where(s => s.CyManagerAlias == "CyManagerAlias1").ToList()
            };
        ...
        {
            // Arrange
            var _mockService = new Mock<ISendStayConversationService>();
            var _mockTaxonomyService = new Mock<IConversationScriptTaxonomyService>();
            var SendStayEntitiesList = TestSendStayEntitiesData();
            var conversationListRequest = new ConversationListRequest
            {
            ...
            var expectedConversation = new SendStayConversationResponse
            {
                Conversations = new List<SendConversationDto>()
            };
        ...
        [Fact]
        public async Task GetStatistic_ShouldReturnOkResponse_WhenDataFound()
        {
            // Arrange
            ...
            _mockService.Setup(service => service.GetStatistics(conversationStatisticRequest, It.IsAny<string>(), It.IsAny<List<string>>())).ReturnsAsync(expectedConversationStatistic);
        ...
        public async Task GetStatistic_ShouldReturnForbiddenResponse_WhenDataNotFound()
        {
            ...
            List<string> roleList = new List<string>() { new string("Manager") };
            _controller.ControllerContext.HttpContext.Items["Roles"] = roleList;
        ...
        public async Task GetStatistic_ReturnsInternalServerError_OnException()
        {
            ...
            _mockService.Setup(service => service.GetStatistics(It.IsAny<ConversationStatisticsRequest>(), It.IsAny<string>(), roleList))
                       .ThrowsAsync(new Exception("Server error encountered while fetching send conversations statistics"));
            ...
            // Assert
            Assert.NotNull(exception);
            Assert.Equal("Server error encountered while fetching send conversations statistics", exception.Message);
        }
        ...
        public async Task GetEmpConversationScript_ShouldReturnOkResponse_WhenDataFound()
        {
            ...
            _mockTaxonomyService.Setup(service => service.GetEmpConversationScript(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>(), It.IsAny<string>())).ReturnsAsync(expectedConversationScript);
        ...
        [Fact]
        public async Task GetEmpConversationScript_ReturnsInternalServerError_OnException()
        {
            string empAlias = "abc";
            var expectedConversationScript = TestConversationScriptData();
            ...
            _mockTaxonomyService.Setup(service => service.GetEmpConversationScript(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>(), It.IsAny<string>())).
                ThrowsAsync(new Exception("No record found with this data.")); ;
            // Act
            var result = await _controller.GetEmpConversationScript(empAlias);
        ...
        private FutureManagerChangeRequest GetFutureManagerChangeRequest()
        {
            var testRequest = new FutureManagerChangeRequest
            {
                UpdatedManager = "SampleManager",
        ...
        private static List<SendConversationDto> TestSendStayEntitiesData()
        {
            return new List<SendConversationDto>()
            {
                ...
                new SendConversationDto()
                {
                 ...
                 FyManagerChange="Y",
                 ConversationStatus="Completed",
                 FyManagerAlias="FyManagerAlias9",
                 EdmValidation ="EdmValidation",
