...
export const ExistingReport = ({
  ...
  const service = "Field BI and Enablement Requests - Enhance Exisitng";
  const requestType = "Enhance Exisitng";
        ...
        <Stack
          ...
          <Stack
            ...
            <Dropdown
              ...
              defaultSelectedKey=""
              options={fieldArea !== null ? fieldArea: configData?.[service]?.typeOfRequest?.[requestType]?.[
                "Field Area"
              ]?.value}
              styles={{
                root: { width: "100%" },
