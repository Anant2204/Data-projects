...
const MoraleEvent = ({
  ...
  const handleEndDate = (value) => {
    ...
    if (value && formData.startDate) { // Checking if both dates are not empty
  ...
  const handleStartDate = (value) => {
    ...
    if (value && formData.endDate) { // Checking if both dates are not empty
