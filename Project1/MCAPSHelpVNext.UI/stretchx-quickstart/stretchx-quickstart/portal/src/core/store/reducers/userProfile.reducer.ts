import { ReduxUserProfileState, FETCH_USER_PROFILE_BEGIN, FETCH_USER_PROFILE_SUCCESS, FETCH_USER_PROFILE_FAILURE, SET_USER_PROFILE_BEGIN, SET_USER_PROFILE_SUCCESS, SET_USER_PROFILE_ERROR } from "../../../app/store";
