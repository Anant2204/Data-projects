param workflows_bulkUserIDAdd_name string = 'bulkUserIDAdd'

resource office365groups2 'Microsoft.Web/connections@2016-06-01' existing = {
  name:'office365groups-2'
}
...
resource workflows_bulkUserIDAdd_name_resource 'Microsoft.Logic/workflows@2017-07-01' = {
  name: workflows_bulkUserIDAdd_name
  ...
  properties: {
    ...
    definition: {
      ...
      parameters: {
        'Server Name': {
          defaultValue: 'mcapshelp.database.windows.net'
          type: 'String'
        }
        'DataBase Name': {
          defaultValue: 'mcapshelpdb'
          type: 'String'
        }
        ToEmail: {
    ...
    parameters: {
      '$connections': {
        value: {
          office365groups: {
            id: office365groups2.properties.api.id
            connectionId: office365groups2.id
            connectionName: 'office365groups-2'
          }
          'sql-1': {
