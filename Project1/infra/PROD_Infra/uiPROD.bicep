param serverfarms_ASP_RGMCAPSHELPDEV_87a4_name string
param location string = 'southcentralus'
param prodFrontend string


resource serverfarms_ASP_RGMCAPSHELPDEV_87a4_name_resource 'Microsoft.Web/serverfarms@2023-01-01' = {
  name: serverfarms_ASP_RGMCAPSHELPDEV_87a4_name
  location: location
  sku: {
    name: 'S1'
    tier: 'Standard'
...
resource sites_mcapshelpdev_name_resource 'Microsoft.Web/sites@2023-01-01' = {
  ...
  properties: {
    ...
    hostNameSslStates: [
      {
        name: '${prodFrontend}.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Standard'
      }
      {
        name: '${prodFrontend}.microsoft.com'
        sslState: 'SniEnabled'
        thumbprint: '14F5B72A5D3250252916E700E12C143CFC9CC332'
        hostType: 'Standard'
      }
      {
        name: '${prodFrontend}.scm.azurewebsites.net'
        sslState: 'Disabled'
        hostType: 'Repository'
      }
    ]
