...
// param servers_mcapshelpexternal_name string = 'mcapshelpProdtelemetryServer'
...
// param mcapshelpexternalDB string = 'mcapshelpProdtelemetryDB'

resource servers_mcapshelpexternal 'Microsoft.Sql/servers/databases@2023-05-01-preview' = {
  // parent: servers_mcapshelpexternal_name_resource
  name: 'mcapshelpprodtelemetryserver/mcapshelpprodtelemetrydb'
