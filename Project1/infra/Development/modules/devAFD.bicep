...
param devApiURL string = 'mcapshelpdevapi'
param devwafPolicyName string = 'WAFmcapshelpdev'
param devwafMode string = 'Prevention'
param devSecurityPolicy string = 'mcapshelpdev'
param devRoute string = 'mcapshelpdevapi'
