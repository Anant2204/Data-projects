param appServicePlanName string = 'ASP-RGMCAPSHELP-UATIRISAPI-9aca'
...
param mcapshelpProdSearchService string = 'mcapshelpsearchuat'
...
//API App
param sites_mcapshelpexternalapiprod_name string = 'mcapshelpexternalapiuat'
param serverfarms_ASP_RGMCAPSHELPDEVIRISAPI_9aca_externalid string = '/subscriptions/dbe10480-e093-4f44-a29c-e69c0f44c583/resourceGroups/RG-MCAPSHELP-UAT-IRISAPI/providers/Microsoft.Web/serverfarms/ASP-RGMCAPSHELP-UATIRISAPI-9aca'
...
resource sites_mcapshelpexternalapidev_name_web 'Microsoft.Web/sites/config@2023-01-01' = {
  ...
  properties: {
    ...
    publishingUsername: '$mcapshelpexternalapiuat'
    scmType: 'None'
...
param workspaces_DefaultWorkspace_28367f8b_80f4_4eb1_a833_88a7108ea20e_SCUS_externalid string = '/subscriptions/dbe10480-e093-4f44-a29c-e69c0f44c583/resourceGroups/DefaultResourceGroup-SCUS/providers/Microsoft.OperationalInsights/workspaces/DefaultWorkspace-dbe10480-e093-4f44-a29c-e69c0f44c583-SCUS'
...
//KeyVault
param vaults_MCAPSHelpExtKeyVaultProd_name string = 'MCAPSHelpExtKeyVaultUat'
...
resource vaults_MCAPSHelpExtKeyVaultDev_name_resource 'Microsoft.KeyVault/vaults@2023-07-01' = {
  ...
  properties: {
    ...
    vaultUri: 'https://mcapshelpextkeyvaultuat.vault.azure.net/'
...
param servers_mcapshelpexternal_name string = 'mcapshelpexternaluat'
...
param mcapshelpexternalDB string = 'mcapshelpexternaluat'
