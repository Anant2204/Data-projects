// <copyright file="NewsRepository.cs" company="Microsoft Corporation">
...
namespace MCAPSHelpVNext.DataRepository.Repository
{
...

    {
        ...
        public NewsRepository(BSODBContext dbContext)
        {
        ...
        {
            var result = _dbContext.Set<News>().FromSqlRaw("EXEC BSO.GetAllNews").AsEnumerable().ToList();
            return result;
        }
    }
}
